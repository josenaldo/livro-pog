                            ...
                            <Grid size={10} padding={2}>
                                ...
                                <Stack gap={3} marginY={3}>
                                    ...
                                    <Typography variant="body1">
                                        O Livro Programação Orientada a
                                        Gambiarra é um projeto de um só autor,
                                        eu, Josenaldo de Oliveira Matos Filho. O
                                        objetivo desse livro é simplesmente
                                        fazer você rir com alguns dos absurdos
                                        que encontramos nessa maravilhosa área
                                    ...
                                    <Typography variant="body1">
                                        Isso aqui não é um crowdfunding. Eu não
                                        vou pedir dinheiro prometendo um prazo
                                        de entrega. Não sei quando vou acabar o
                                        livro. A coisa simplesmente está fluindo
                                        e eu deixo rolar.
                                    </Typography>
                                    <Typography variant="body1">
                                        Se, mesmo sabendo disso, você for
                                        acometido por um desejo insano de tacar
                                        patacos de dinheiros em minha fuça, não
                                        se sinta constrangido e dê vazão à essa
                                        sua vontade!
                                    </Typography>
                                    <Typography variant="body1">
                                        Manda um PIX!
                                    ...
                                    <Typography variant="body1">
                                        Sim. Eu sou aposentado. Isso não quer
                                        dizer que eu seja desocupado. Tem ideia
                                        de quanto tempo leva pra você, deitado
                                    ...
                                    <Typography variant="body1">
                                        ...
                                        espancado por um babuíno pelado pintado
                                        de azul. É a vida.
                                    </Typography>
                                    <Typography variant="body1">
                                        Mas uma coisa eu te garanto: Nesse
                                        momento, estou com o Shift Del apontado
                                        para o livro. Ou você me doa dinheiro,
                                        ou ele será deletado.
                                    </Typography>
                                    <Typography variant="body1">
                                        Brincadeira.
                                    </Typography>
                                    ...
                                    <Typography variant="body1">
                                        ...
                                        estimular a escrever outras coisas.
                                        Quanto mais doações eu receber, mais
                                    ...
                                    <Typography variant="body1">
                                        ...
                                        disponível pra quem quiser ler. Mas
                                        planejo, no futuro, vender o formato
                                    ...
                                    <Typography variant="body1">
                                        Se houver masoquistas interessados, sim.
                                        Não julgo como as pessoas gostam de
                                        obter o seu prazer.
                                    </Typography>
                                </Stack>
                            </Grid>
